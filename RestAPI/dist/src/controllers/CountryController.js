...
const GetCountriesRoute_1 = __importDefault(require("../routes/GetCountriesRoute"));
let CountryController = class CountryController {
    handlerGetCountries = async (req, reply) => new GetCountriesRoute_1.default().run(req, reply);
};
__decorate([
    (0, fastify_decorators_1.GET)('/', {
        schema: {
            querystring: fluent_json_schema_1.default.object().prop('input', fluent_json_schema_1.default.string().required()),
            response: {
...
], CountryController.prototype, "handlerGetCountries", void 0);
CountryController = __decorate([
    (0, fastify_decorators_1.Controller)('/country')
], CountryController);
